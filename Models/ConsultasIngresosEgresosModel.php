<?php
	class ConsultasIngresosEgresosModel extends Mysql
	{
		...
		public function selectEdoCuentaByMatriculaRFC($str, string $nomConexion){
			$datosAlumno = $str;
		...
		public function selectDatosAlumnoByMatriculaRFC($str, string $nomConexion){
		...
		public function selectEdoCuentaById(int $idAlumno, string $nomConexion){
        ...
        public function selectStatusEstadoCuentaById(int $idPersonaSeleccionada, string $nomConexion){
       ...
       /*  public function selectStatusEstadoCuentaByMatrRFC($matriculaRFC){
		...
		public function selectIdAlumnoByRFC($rfc, string $nomConexion){
		...
		public function selectIdAlumnoByMatricula($matricula, string $nomConexion){
		...
		/////////////////////////
		public function selectEdoCta(int $idAlumno, string $nomConexion){
		...
		public function selectDetallePago(int $idPrecarga, int $idPersona, string $nomConexion){

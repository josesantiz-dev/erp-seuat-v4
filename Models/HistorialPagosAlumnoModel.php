<?php
	class HistorialPagosAlumnoModel extends Mysql
	{
		...
		public function selectDetalleEstudiante(int $idAlumno, string $nomConexion){
		...
		public function selectUltimosMovimientos(int $idAlumno, string $nomConexion){
		...
		public function selectTodosMovimientos(int $idAlumno, string $nomConexion){

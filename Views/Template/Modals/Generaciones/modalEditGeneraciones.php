<div class="modal fade" id="ModalFormGeneracionEditar" data-backdrop="static" data-keyboard="true" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="card mt-1">
          ...
          <form id="formGeneracionesUp" name="formGeneracionesUp" autocomplete="off">

            <input type="hidden" id="idGeneracionesUp" name="idGeneracionesUp">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label for="txtNombre_GeneracionUp">Nombre generación <span class="required">*</span></label>
                <input type="text" id="txtNombre_GeneracionUp" name="txtNombre_GeneracionUp" class="form-control valid validText" placeholder="Ingrese una nueva categoría"  name="Ingresa el nombre de la categoría" required="">
              </div>
              <div class="form-group">

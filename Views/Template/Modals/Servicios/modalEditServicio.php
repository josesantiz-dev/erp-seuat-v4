        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card card-dark">
                    <form id="formServicios_edit" name="formServicios_edit" autocomplete="off">
                        <input type="hidden" id="idServicioEdit" name="idServicioEdit" value="">
                        <div class="card-body">
							...
							<div class="form-row">
								<div class="form-group col-sm-12 col-md-6">
									...
									<input type="text" id="txtCodigo_servicio_edit" name="txtCodigo_servicio_edit" class="form-control form-control-sm valid validText" placeholder="Ingrese el código para indentificar el servicio"  maxlength="10" required="" >
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-sm-12 col-md-10">
									<label for="txtNombre_servicio_edit">Nombre servicio </label>
									<input type="text" id="txtNombre_servicio_edit" name="txtNombre_servicio_edit" class="form-control form-control-sm valid validText" placeholder="Ingrese el nombre del nuevo servicio"  maxlength="100" required="" >
								</div>
							...
							<div class="form-row">
							    <div class="form-group col-md-5">
								    <label for="listIdCategoria_servicio_edit">Categoría</label>
									<select class="form-control form-control-sm" id="listIdCategoria_servicio_edit" name="listIdCategoria_servicio_edit" style="width: 100%;" required="" >
								...
								<div class="form-group col-md-2">
								    <label for="listAnioFiscal_edit">Año fiscal</label>
									<select class="form-control form-control-sm" id="listAnioFiscal_edit" name="listAnioFiscal_edit" style="width: 100%;" required="" >
							...
							<div class="form-row">
								<div class="form-group col-sm-12 col-md-12">
									<div class="custom-control custom-checkbox col-sm-12 col-md-12 toggle-flip">
									    <input class="custom-control-input custom-control-input-primary" type="checkbox" id="chkAplica_edo_cuenta_edit" name="chkAplica_edo_cuenta_edit" >
									    <label for="chkAplica_edo_cuenta_edit" class="custom-control-label text-lead">Aplicar en el estado de cuenta.</label>
									</div>
								</div>
							</div>
                            ...
                            <div class="form-group col-4">
                                <label>Estatus</label>
                                <select class="form-control form-control-sm" id="list_estatus_servicios_edit" name="list_estatus_servicios_edit" >
